export default {
    kraamweek: {
        ...
        firstParagraphs: [{
            ...
            title: "",
            content: "Het eerste bezoek is meestal een mooi moment om terug te kijken op het verloop van de zwangerschap en de bevalling. We nemen graag de tijd om eventuele vragen in alle rust te bespreken. Hoe vaak we bij je thuis langskomen en wanneer hangt af van jullie behoeftes en het herstel. De meeste moeders hebben na anderhalve week hun eigen draai gevonden en geven aan dat de regelmatige bezoekjes niet meer nodig zijn. Tijdens de kraamweek, maar ook daarna kan je ons dag en nacht bereiken voor hulp en ondersteuning en indien nodig komen we, ook ’s nachts, extra bij je langs."
        }, {
            title: "Kraamverzorgster",
            content: " In de periode direct na de bevalling komt de kraamverzorgster bij jullie langs. Afhankelijk van jullie situatie zal zij gedurende de eerste week gemiddeld 7 uur per dag voor jullie paraat staan om jullie te ondersteuning tijdens de kraamweek. Ze leert je van alles over de verzorging van je baby, neemt huishoudelijke taken van je over en helpt je structuur te krijgen in deze bijzondere, maar vaak ook intensieve, periode."
        }, {
            title: "",
            content: "Wij werken nauw samen met de kraamverzorgster. Zij is onze oren en onze ogen en zo vullen wij elkaar samen aan om jullie van het juist advies en ondersteuning te voorzien."
        },]
    },
    nacontrole: {
        ...
        firstParagraphs: [{
            ...
            title: "",
            content: "De nacontrole is een fijne manier om zo onze zorg rondom deze zwangerschap, bevalling en kraamperiode af te sluiten."
        },
    ]
    },
    geboorteaangifte: {
    ...
    borstvoeding: {
        ...
        firstParagraphs: [{
            ...
            title: "",
            content: "Tijdens de zwangerschap is je lichaam bezig om zich voor te bereiden op het geven van borstvoeding. Na de bevalling is je moedermelk direct beschikbaar in de juiste samenstelling en hoeveelheid. De eerste moedermelk die een baby drinkt heet colostrum. Dit is zeer geconcentreerde moedermelk en zit boordenvol antistoffen die je baby direct na de geboorte beschermen tegen infecties. Je baby heeft maar een paar druppels van deze voeding nodig. Dat is maar goed ook, want een pasgeboren baby heeft een maagje ter grootte van een kleine knikker die elke dag een klein beetje groter wordt. Jouw borstvoeding is uniek van samenstelling en helemaal afgestemd op de behoefte van je kind. Als je kind ouder wordt, groeit jouw moedermelk met hem of haar mee."
        }, {
            title: "",
            content: "Wat zijn nou precies de voordelen van het geven van borstvoeding? Hieronder enkele voordelen op een rij. "
        }, {
            title: "",
            content: " - Het beschermt de baby tegen infecties en ziektes. \n- Moedermelk heeft de perfecte samenstelling voor een baby en veranderd als de baby ouder wordt en andere behoeftes heeft. \n- Het is direct beschikbaar en op goede temperatuur. \n- Het geven van borstvoeding heeft ook voordelen voor de moeder. Het verkleint de kans op borstkanker, eierstokkanker, ouderdomssuikerziekte en depressies. \n- Het heeft ook voordelen voor het kind op oudere leeftijd. Volwassenen die als baby borstvoeding hebben gekregen hebben een kleinere kans op overgewicht en ouderdomssuikerziekte en scoren hoger op intelligentietests."
        }, 
    ]
    },
    kunstvoeding: {
        ...
        firstParagraphs: [{
            ...
            title: "",
            content: "Baby’s die flesvoeding krijgen hebben extra behoefte aan lichamelijk contact dit is belangrijk voor de gezonde (hersen)ontwikkeling. Wees daar extra alert op en maak van de flesvoeding een momentje samen. Het is verstandig om, zeker de eerste weken, zelf de fles te geven. Hierdoor leren jullie elkaar beter kennen en voorkom je dat je kind overprikkeld raakt."
        }, {
            title: "",
            content: "Standaard zuigelingenvoeding 0-6 maanden kun je meteen vanaf de geboorte aan je baby geven. Er zijn veel verschillende soorten en merken poedermelk te koop. Alle merken in Nederland moeten aan strenge kwaliteitseisen voldoen. Het maakt daardoor niet zo veel uit welk merk je kiest. De hoeveelheid melk die je aan je baby geeft is per dag en per kind verschillend. De kraamverzorgster en wij als verloskundige zullen jou hiermee helpen."
        },
    ]
    },
    vruchtbaarheid: {
        ...
        firstParagraphs: [{
            ...
            title: "",
            content: "Op het moment dat je na de bevalling weer voor het eerst gemeenschap hebt, bestaat er dus ook een kans dat je weer zwanger wordt. Een zwangerschap duurt gemiddeld negen maanden. Na de bevalling heeft je lichaam ook minstens negen maanden nodig om hiervan te herstellen. Het is daarom verstandig om in deze periode niet opnieuw zwanger te worden. Als je niet het risico wilt lopen om direct na de bevalling weer zwanger te worden, is het verstandig om na te denken over hoe je dit wilt voorkomen. In sommige gevallen kan het geven van volledig borstvoeding de kans op een zwangerschap aanzienlijk verkleinen, maar dit is niet helemaal uit te sluiten. De meeste ouders kiezen er daarom voor om een voorbehoedsmiddel te gebruiken."
        }, {
            title: "",
