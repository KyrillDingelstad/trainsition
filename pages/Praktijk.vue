<template>
  <page class="praktijk">
    ...
    <p class=standaardp>Veilig Zwanger Ambacht is een kleinschalige praktijk. Wij werken in de praktijk twee verloskundigen, Sandra en Ineke. Zo krijg je bij ons altijd een bekend gezicht te zien, en we staan hierbij dag en nacht voor je klaar.</p>
    ...
    <p class=standaardp>Ons sterke punt is de kleinschaligheid van de praktijk en onze nauwe samenwerking. Je leert ons tijdens de zwangerschap heel goed kennen en zo bouwen we samen aan een vertrouwensband. In de loop der jaren hebben we gemerkt hoe belangrijk die is.
    Deze band helpt je veilig te voelen en te kunnen ontspannen in de zwangerschap en is een voorwaarde om vertrouwen in je lichaam te krijgen. Dit is essentieel voor een goed verloop van je zwangerschap, bevalling en het nieuwe ouderschap.</p>

    <p class=standaardp>Ook al zijn we kleinschalig, bij ons in de praktijk bieden we zorg rondom de zwangerschap zo breed mogelijk aan. Dit betekent dat je bij ons in de praktijk ook terecht kunt voor vragen over zwanger worden, verloskundige zorg, echo’s en anticonceptie.</p>
